package com.mongodb.stitch.android.services;
...
public interface StitchService {
   ...
   * @return A {@link Task} containing the decoded value.
   */
  <TResult> Task<TResult> callFunction(final String name, final List<? extends Object> args, final Codec<TResult> resultCodec);
}
