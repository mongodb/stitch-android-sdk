...
## Documentation
* [API/Javadoc Documentation](https://docs.mongodb.com/stitch-sdks/java/4.4.0/index.html)
...
```gradle
implementation 'org.mongodb:stitch-android-sdk:4.4.0'
```
...
```gradle
implementation 'org.mongodb:stitch-android-core:4.4.0'
implementation 'org.mongodb:stitch-android-services-aws:4.4.0'
implementation 'org.mongodb:stitch-android-services-fcm:4.4.0'
implementation 'org.mongodb:stitch-android-services-http:4.4.0'
implementation 'org.mongodb:stitch-android-services-mongodb-remote:4.4.0'
implementation 'org.mongodb:stitch-android-services-twilio:4.4.0'
```
...
```gradle
implementation 'org.mongodb:stitch-server-sdk:4.4.0'
```
...
```gradle
implementation 'org.mongodb:stitch-server-core:4.4.0'
implementation 'org.mongodb:stitch-server-services-aws:4.4.0'
implementation 'org.mongodb:stitch-server-services-fcm:4.4.0'
implementation 'org.mongodb:stitch-server-services-http:4.4.0'
implementation 'org.mongodb:stitch-server-services-mongodb-remote:4.4.0'
implementation 'org.mongodb:stitch-server-services-twilio:4.4.0'
```
