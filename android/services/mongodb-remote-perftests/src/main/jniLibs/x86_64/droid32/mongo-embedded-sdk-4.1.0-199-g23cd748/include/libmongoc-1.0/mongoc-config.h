...
#define MONGOC_USER_SET_CFLAGS "-isystem /data/mci/54b54062137c8e8ea914e5c181168e55/android_sdk/ndk-bundle/sysroot/usr/include/arm-linux-androideabi -D__ANDROID_API__=24 -g -DANDROID -ffunction-sections -funwind-tables -fstack-protector-strong -no-canonical-prefixes -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -mthumb -Wa,--noexecstack -Wformat -Werror=format-security "

#define MONGOC_USER_SET_LDFLAGS "-Wl,--exclude-libs,libgcc.a -Wl,--exclude-libs,libatomic.a -nostdlib++ --sysroot /data/mci/54b54062137c8e8ea914e5c181168e55/android_sdk/ndk-bundle/platforms/android-24/arch-arm -Wl,--build-id -Wl,--warn-shared-textrel -Wl,--fatal-warnings -Wl,--fix-cortex-a8 -Wl,--exclude-libs,libunwind.a -L/data/mci/54b54062137c8e8ea914e5c181168e55/android_sdk/ndk-bundle/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a -Wl,--no-undefined -Wl,-z,noexecstack -Qunused-arguments -Wl,-z,relro -Wl,-z,now -Wl,--gc-sections -Wl,-z,nocopyreloc -pie -fpie "

/* MONGOC_CC is used to determine what C compiler was used to compile mongoc */
#define MONGOC_CC "/data/mci/54b54062137c8e8ea914e5c181168e55/android_sdk/ndk-bundle/toolchains/llvm/prebuilt/linux-x86_64/bin/clang"
