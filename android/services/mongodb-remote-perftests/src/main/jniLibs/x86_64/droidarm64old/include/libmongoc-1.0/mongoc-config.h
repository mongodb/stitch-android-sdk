...
#define MONGOC_USER_SET_CFLAGS "-isystem /data/mci/154c60dd20bcd4b882a284d33947820f/android_sdk/ndk-bundle/sysroot/usr/include/aarch64-linux-android -D__ANDROID_API__=24 -g -DANDROID -ffunction-sections -funwind-tables -fstack-protector-strong -no-canonical-prefixes -Wa,--noexecstack -Wformat -Werror=format-security "

#define MONGOC_USER_SET_LDFLAGS "-Wl,--exclude-libs,libgcc.a -Wl,--exclude-libs,libatomic.a -nostdlib++ --sysroot /data/mci/154c60dd20bcd4b882a284d33947820f/android_sdk/ndk-bundle/platforms/android-24/arch-arm64 -Wl,--build-id -Wl,--warn-shared-textrel -Wl,--fatal-warnings -L/data/mci/154c60dd20bcd4b882a284d33947820f/android_sdk/ndk-bundle/sources/cxx-stl/llvm-libc++/libs/arm64-v8a -Wl,--no-undefined -Wl,-z,noexecstack -Qunused-arguments -Wl,-z,relro -Wl,-z,now -Wl,--gc-sections -Wl,-z,nocopyreloc -pie -fpie "

/* MONGOC_CC is used to determine what C compiler was used to compile mongoc */
#define MONGOC_CC "/data/mci/154c60dd20bcd4b882a284d33947820f/android_sdk/ndk-bundle/toolchains/llvm/prebuilt/linux-x86_64/bin/clang"
