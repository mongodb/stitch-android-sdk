...
#define MONGOC_USER_SET_CFLAGS "-arch x86_64 -isysroot /Applications/Xcode9.2.0.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.13.sdk -mmacosx-version-min=10.10"

#define MONGOC_USER_SET_LDFLAGS ""

/* MONGOC_CC is used to determine what C compiler was used to compile mongoc */
#define MONGOC_CC "/Applications/Xcode9.2.0.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/cc"
