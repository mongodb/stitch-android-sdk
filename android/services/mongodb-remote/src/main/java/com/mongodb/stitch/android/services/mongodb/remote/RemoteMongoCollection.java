...
public interface RemoteMongoCollection<DocumentT> {
   ...
   */
  Task<ChangeStream<Task<ChangeEvent<DocumentT>>, ChangeEvent<DocumentT>>> watch(final ObjectId... ids);
   ...
   * @return the stream of change events.
   */
  Task<ChangeStream<Task<ChangeEvent<DocumentT>>, ChangeEvent<DocumentT>>> watch(final BsonValue... ids);
   ...
   * @return the stream of change events.
   */
  Task<ChangeStream<Task<CompactChangeEvent<DocumentT>>, CompactChangeEvent<DocumentT>>> watchCompact(final ObjectId... ids);
   ...
   * @return the stream of change events.
   */
  Task<ChangeStream<Task<CompactChangeEvent<DocumentT>>, CompactChangeEvent<DocumentT>>> watchCompact(final BsonValue... ids);
