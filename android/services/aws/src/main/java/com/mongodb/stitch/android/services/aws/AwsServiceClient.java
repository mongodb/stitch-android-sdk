...
import com.mongodb.stitch.android.services.aws.internal.AwsServiceClientImpl;
...
public interface AwsServiceClient {
   ...
   */
  Task<Void> execute(@Nonnull final AwsRequest request);
  ...
  NamedServiceClientFactory<AwsServiceClient> factory =
      new NamedServiceClientFactory<AwsServiceClient>() {
        @Override
        public AwsServiceClient getClient(
            final CoreStitchServiceClient service,
            final StitchAppClientInfo appInfo,
            final TaskDispatcher dispatcher
        ) {
          return new AwsServiceClientImpl(new CoreAwsServiceClient(service), dispatcher);
        }
      };
}
