...
public interface CoreSyncMongoDatabase extends CoreRemoteMongoDatabase {
   ...
   */
  CoreSyncMongoCollection<Document> getCollection(final String collectionName);
   ...
   * @return the collection
   */
  <DocumentT> CoreSyncMongoCollection<DocumentT> getCollection(
