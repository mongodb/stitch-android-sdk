...
public class CoreAwsS3ServiceClientUnitTests {
  ...
  public void testPutObject() throws IOException {
    ...
    doReturn(new AwsS3PutObjectResult(expectedLocation))
    ...
    assertEquals(AwsS3PutObjectResult.Decoder, resultClassArg.getValue());
  ...
  public void testSignPolicy() {
    ...
    doReturn(new AwsS3SignPolicyResult(
        expectedPolicy,
        expectedSignature,
        expectedAlgorithm,
        expectedDate,
    ...
    expectedArgs.put("contentType", contentType);
    assertEquals(expectedArgs, funcArgsArg.getValue().get(0));
    assertEquals(AwsS3SignPolicyResult.Decoder, resultClassArg.getValue());
