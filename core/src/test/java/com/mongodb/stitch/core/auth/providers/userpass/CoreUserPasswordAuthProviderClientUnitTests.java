...
public class CoreUserPasswordAuthProviderClientUnitTests {
  ...
  private final CoreUserPasswordAuthProviderClient core =
              ...
              (Request request) -> {
                try {
                  ...
                  if (request.getUrl().contains("register")) {
                    assertEquals(
                        new Document("email", this.username).append("password", this.password),
                        body);
  ...
  public void testCredential() {
    final UserPasswordCredential credential = core.getCredential(this.username, this.password);
  ...
  public void testRegister() {
    core.registerWithEmailInternal(this.username, this.password);
  }
